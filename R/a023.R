...
#     ell.pl.i <- log(cdivy^(exp.xtb.pl.i+1) - cdivyp1^(exp.xtb.pl.i+1))
#     return(ell.pl.i)
#   }
# 
...
#     delldbeta.pl.i <- x.pl.extended[i,]%*%exp.xtb.pl.i%*%(  1/(exp.xtb.pl.i+1)  + log(c.pl) - log(y[i]) )
#     return(delldbeta.pl.i)
#   }
# 
...
#     #hessian.pl.i <- x.pl.extended[i,]%*%t(x.pl.extended[i,])*as.numeric(  exp.xtb.pl.i/(exp.xtb.pl.i+1)^2  +  1/(exp.xtb.pl.i+1)  +  log(c.pl)  - log(y[i]) )
#     return(hessian.pl.i)
#   }
# 
...
# 
#   #sourceCpp("a019.cpp")
#   #log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
#   #log.lik.fun(beta.zc.multinomial.old,beta.pl.multinomial.old,theta.nb.old,beta.pl.old,c.pl)
# 
# 
...
#     # ##Testing
#     #sourceCpp("a019.cpp")
#     #test_log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
#     #log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
#     # ##End testing
# 
...
#     #upd.obj <- update_bfgs_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y,max.upd.par,1)
# 
#     ##Testing
#     # i <- 93
#     # sourceCpp("a019.cpp")
#     # test.fun_i <- function(beta.pl.tmp){
#     #   #target_i <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.tmp,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
#     #   target_i <- ell_pl_i_fun(beta.pl.tmp,c.pl,x.pl.extended[i,],y[i])
#     # }
#     #
#     # maxLik::numericGradient(f=test.fun_i,t0=beta.pl.old)
#     # delldbeta.pl.i.fun.approx(beta.pl.old)
#     # delldbeta.pl.i.fun.exact(beta.pl.old)
#     # delldbeta_pl_i_fun_approx(beta.pl.old,c.pl,x.pl.extended[i,],y[i])
#     # delldbeta_pl_i_fun_approx_test(beta.pl.old,c.pl,x.pl.extended[i,],y[i])
#     #End testing
# 
# 
# 
...
#     ##############Testing maxfun
#     # sourceCpp("a019.cpp")
#     # test.opt.fun <- function(beta.pl.tmp){
#     #   #Go back eta times the step that was already made
#     #   target <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old, beta.pl.tmp,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
#     #   return(target)
#     # }
#     #
#     # maxLik::numericGradient(test.opt.fun,beta.pl.old)
#     #
#     #
#     # i <- 93
#     # delldbeta.pl.i.fun.approx(beta.pl.old)
...
#     # maxLik::numericGradient(test.opt.fun,beta.pl.old)
#     #
#     # d2elldbeta2_pl_i_fun_approx(beta.pl.old,c.pl,x.pl.extended[i,],y[i])
#     # maxLik::numericHessian(f=test.opt.fun,t0=beta.pl.old)
#     #
#     # test.opt.fun <- function(theta.nb.tmp){
#     #   beta.nb.tmp <- theta.nb.tmp[1:n.beta.nb]
#     #   alpha.nb.tmp <- theta.nb.tmp[n.beta.nb+1]
#     #   target <- ell_nb_i_fun(beta.nb.tmp,alpha.nb.tmp,x.nb.extended[i,],y[i])
#     # }
#     # exact.test <- delldtheta_nb_i_fun(beta.nb.old,alpha.nb.old,x.nb.extended[i,],y[i])
#     #
#     # num.test <- maxLik::numericGradient(test.opt.fun,theta.nb.old)
#     #
#     ####End testing
# 
# 
