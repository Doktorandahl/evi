...
zerinfl.nb.pl.reg.cond.c.fun <- function(y,x.obj,ini.val,control){
  ...
  while(i.em<max.no.em.steps & max.abs.par.diff>max.diff.par){
    ...
    func.val.before.bfgs <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
    
    
    ###########
    #Update beta.nb and alpha.nb
    #########
    
    theta.nb.new <- update_theta_nb_fun(resp,beta.nb.old,alpha.nb.old,x.nb.extended,x.pl.extended,y,no.m.bfgs.steps,max.upd.par)
    
    change.nb.bfgs <- theta.nb.new - theta.nb.old
    theta.nb.old <- theta.nb.new
    ...
    func.val.after.nb <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
    ...
    nb.log.lik.optim <- function(eta){
      ...
      theta.nb.old <- c(beta.nb.old,alpha.nb.old) + eta*change.nb.bfgs# change.nb.bfgs
    ...
    if(is.na(func.val.after.nb)==FALSE){
      if(func.val.after.nb<func.val.before.bfgs){
    ...
    if(sum(is.na(beta.nb.new))==0){
      beta.nb.old <- beta.nb.new
    }else{
      beta.nb.new <- beta.nb.old
      na.beta.nb <- na.beta.nb + length(is.na(beta.nb.new))
    }
    
    if(sum(is.na(alpha.nb.new))==0){
      alpha.nb.old <- alpha.nb.new
    }else{
      alpha.nb.new <- alpha.nb.old
      na.alpha.nb <- na.alpha.nb + length(is.na(alpha.nb.new))
    }
    ##################################
    ##############################################
    ...
    func.val.after.pl <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
    ...
    func.val.after.zc.multinomial <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
    ...
    func.val.after.pl.multinomial <- log_lik_fun(beta.zc.multinomial.old,beta.pl.multinomial.old,beta.nb.old,alpha.nb.old,beta.pl.old,c.pl,x.multinom.zc.extended,x.multinom.pl.extended,x.nb.extended,x.pl.extended,y)
