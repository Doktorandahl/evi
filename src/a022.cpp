...
//
// //[[Rcpp::export]]
// arma::mat testHess(arma::vec beta_nb, double alpha_nb, arma::vec x_nb_ext_i, int y_i){
//   int n_beta_nb = beta_nb.size();
//
//   arma::mat xtb_nb_i = trans(x_nb_ext_i)*beta_nb;
//   double a = xtb_nb_i.eval()(0,0);
...
//
// //[[Rcpp::export]]
// arma::mat update_props_fun(arma::vec gamma_z, arma::vec gamma_pl, arma::mat x_mult_z_ext,arma::mat x_mult_pl_ext){
//   int n = x_mult_z_ext.n_rows;
//   int n_mult_z = x_mult_z_ext.n_cols;
//   int n_mult_pl = x_mult_pl_ext.n_cols;
//   arma::mat props = zeros<mat>(n,3) ;
...
//
// //[[Rcpp::export]]
// arma::mat update_resp_fun(arma::mat props,arma::vec beta_nb,double alpha_nb, arma::vec beta_pl, double c_pl,arma::mat x_nb_ext, arma::mat x_pl_ext, arma::vec y){
//   int n = x_nb_ext.n_rows;
//   int n_nb = x_nb_ext.n_cols;
//   int n_pl = x_pl_ext.n_cols;
//
...
//     if(y(i)==0){
//       double d_nb = exp(ell_nb_i_fun(beta_nb,alpha_nb,trans(x_nb_ext.submat(i,0,i,n_nb-1)),y(i)));
...
//     }else if(y(i)>=c_pl){
//       double d_nb = exp(ell_nb_i_fun(beta_nb,alpha_nb,trans(x_nb_ext.submat(i,0,i,n_nb-1)),y(i)));
//       double d_pl = exp(ell_pl_i_fun(beta_pl,c_pl,trans(x_pl_ext.submat(i,0,i,n_pl-1)),y(i)));
...
//
// //[[Rcpp::export]]
// arma::mat test_update_theta_nb_fun(arma::mat resp, arma::vec beta_nb, double alpha_nb, arma::mat x_nb_ext, arma::mat x_pl_ext, arma::vec y, int no_m_bfgs_steps, double max_upd_par){
//   int n = x_nb_ext.n_rows;
//   int n_nb = x_nb_ext.n_cols;
//   int n_pl = x_pl_ext.n_cols;
//   arma::mat change_nb_bfgs = zeros<mat>(n_nb+1,1);
//   arma::vec beta_nb_new = beta_nb;
//   double alpha_nb_new = alpha_nb;
//
//   //arma::mat test = zeros<mat>(n_nb+1,n_nb+1);
//
...
//     for(int i=0; i<n; i++){
//
//       dQdtheta_nb = dQdtheta_nb + delldtheta_nb_i_fun(beta_nb,alpha_nb,trans(x_nb_ext.submat(i,0,i,n_nb-1)),y(i))*resp(i,1);
//       d2Qdtheta2_nb = d2Qdtheta2_nb + d2elldtheta2_nb_i_fun(beta_nb,alpha_nb,trans(x_nb_ext.submat(i,0,i,n_nb-1)),y(i))*resp(i,1);
//     }
//     //test = d2Qdtheta2_nb;
//
//     change_nb_bfgs = -inv(d2Qdtheta2_nb)*dQdtheta_nb;
//
//     // double maxabschange = max(abs(change_nb_bfgs)).eval()(0,0);
//     // if(maxabschange>max_upd_par){
//     //   change_nb_bfgs = max_upd_par/maxabschange*change_nb_bfgs;
//     // }
//
//     beta_nb = beta_nb + change_nb_bfgs.submat(0,0,n_nb-1,0);
//     alpha_nb = alpha_nb + change_nb_bfgs.submat(n_nb,0,n_nb,0).eval()(0,0);
//
//   //}
//
//   arma::vec theta_nb = zeros<vec>(n_nb+1);
//   theta_nb.subvec(0,n_nb-1) = beta_nb;
//   theta_nb.subvec(n_nb,n_nb) = alpha_nb;
//
//
//   return(change_nb_bfgs);
// }
//
//
// //[[Rcpp::export]]
// arma::mat update_theta_nb_fun(arma::mat resp, arma::vec beta_nb, double alpha_nb, arma::mat x_nb_ext, arma::mat x_pl_ext, arma::vec y, int no_m_bfgs_steps, double max_upd_par){
//   int n = x_nb_ext.n_rows;
//   int n_nb = x_nb_ext.n_cols;
//   int n_pl = x_pl_ext.n_cols;
//   arma::mat change_nb_bfgs = zeros<mat>(n_nb+1,1);
...
//
// //[[Rcpp::export]]
// arma::vec update_beta_pl_fun(arma::mat resp, arma::vec beta_pl, double c_pl, arma::mat x_pl_ext, arma::vec y, int no_m_bfgs_steps, double max_upd_par){
//   int n = x_pl_ext.n_rows;
//   int n_pl = x_pl_ext.n_cols;
...
//     for(int i=0; i<n; i++){
//       if(y(i)>=c_pl){
//         dQdbeta_pl = dQdbeta_pl + delldbeta_pl_i_fun_approx(beta_pl,c_pl,trans(x_pl_ext.submat(i,0,i,n_pl-1)),y(i))*resp(i,2);
//         d2Qdbeta2_pl = d2Qdbeta2_pl + d2elldbeta2_pl_i_fun_approx(beta_pl,c_pl,trans(x_pl_ext.submat(i,0,i,n_pl-1)),y(i))*resp(i,2);
//       }
//     }
//
//     change_pl_bfgs = -inv(d2Qdbeta2_pl)*dQdbeta_pl;
//
//     double maxabschange = max(abs(change_pl_bfgs)).eval()(0,0);
//     if(maxabschange>max_upd_par){
//       change_pl_bfgs = max_upd_par/maxabschange*change_pl_bfgs;
//     }
//     beta_pl = beta_pl + change_pl_bfgs;
//
//   }
//   return(beta_pl);
// }
//
// //[[Rcpp::export]]
// arma::vec update_gamma_z_fun(arma::mat resp,arma::vec gamma_z, arma::vec gamma_pl, arma::mat x_mult_z_ext, arma::mat x_mult_pl_ext, arma::vec y, int no_m_bfgs_steps, double max_upd_par){
//
//   int n = x_mult_z_ext.n_rows;
//   int n_mult_z = x_mult_z_ext.n_cols;
//   int n_mult_pl = x_mult_pl_ext.n_cols;
...
//
//     for(int i=0; i<n; i++){
//       double xtgamma_z_i = (x_mult_z_ext.submat(i,0,i,n_mult_z-1)*gamma_z).eval()(0,0);
//       double xtgamma_pl_i = (x_mult_pl_ext.submat(i,0,i,n_mult_pl-1)*gamma_pl).eval()(0,0);
//       arma::mat xtx_gamma_z_i = trans(x_mult_z_ext.submat(i,0,i,n_mult_z-1))*x_mult_z_ext.submat(i,0,i,n_mult_z-1);
//       double denominator = (1 + exp(xtgamma_z_i) + exp(xtgamma_pl_i));
...
//
//
//     double maxabschange = max(abs(change_mult_z_bfgs)).eval()(0,0);
//     if(maxabschange>max_upd_par){
//       change_mult_z_bfgs = max_upd_par/maxabschange*change_mult_z_bfgs;
//     }
//     gamma_z = gamma_z + change_mult_z_bfgs;
//
//   }
//   return(gamma_z);
// }
//
// //[[Rcpp::export]]
// arma::vec update_gamma_pl_fun(arma::mat resp,arma::vec gamma_z, arma::vec gamma_pl, arma::mat x_mult_z_ext, arma::mat x_mult_pl_ext, arma::vec y, int no_m_bfgs_steps, double max_upd_par){
//
//   int n = x_mult_z_ext.n_rows;
//   int n_mult_z = x_mult_z_ext.n_cols;
//   int n_mult_pl = x_mult_pl_ext.n_cols;
...
//
//     double maxabschange = max(abs(change_mult_pl_bfgs)).eval()(0,0);
//     if(maxabschange>max_upd_par){
//       change_mult_pl_bfgs = max_upd_par/maxabschange*change_mult_pl_bfgs;
//     }
//     gamma_pl = gamma_pl + change_mult_pl_bfgs;
//
//   }
//   return(gamma_pl);
// }
